...
$name = $_POST['name'];
$next = $_POST['next'];
$next_img = $_POST['next_img'];
$next2 = $_POST['next2'];
$next2_img = $_POST['next2_img'];
$cat = "movie";
$desc_1 = $_POST['desc_1'];
$desc_2 = $_POST['desc_2'];
...
$content = '<center> <div style="width: 60%; margin-top: 15%; height: 100px; border-radius: 20px; background: rgb(237, 240, 250); box-shadow: 4px 4px 14px 6px rgba(0,0,0,0.4);"> <h1 style="color: red; font-size: 40px; margin-top: 27px; display: inline-block;">Movie Successfully Uploded..</h1> </div> </center>'; 
...
$create = fopen('../../movies/' . $file.'/index.php', "w");

///////////////////////////////////////////////////////////////
//---------------HTML Content Begin Here.......................//
///////////////////////////////////////////////////////////////

$data = fwrite($create, ' <!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
function ads(value) {
    ...
    if (value == 0) {
        ...
        url = "../videos/video.mp4";
        document.getElementById("vid").src = " '. $video_url . ' ";
        document.getElementById("skip").style.display = "none";
...
<a href=" '. $next . ' "><button style=" width: 200px; height: 50px; border-radius: 10px;" id="nxt" class="skp pc">Next movie <i class="fa fa-step-forward"> </i> </button></a>
</div>
...
<!----------------------- details ------------------------------------------------------------->
   ...
   <div style="margin-top: 140px;" id="detail" class="detail">
        <h1 style="color: white; display: inline-block;" id="dha">'.$name .'</h1> <br>
        <a style="color: lightgreen;" href="../"><p><i class="fa fa-film"> </i> <span> </span>'. $cat .'</p></a>
...
function des2(value) {
    ...
    <div class="desc">
        ...
        <p id="dpa" style="color: white;">'. $desc_1 .'<a style="display:inline-block;" onclick="des(1)" id="daa">Read More...</a></p>
        <p id="dpb" style="color: white; display: none;">'. $desc_2 . '</p>
    </div>
...
<center>
<a href=" '. $next . ' "><button class="btn black">Next <i class="fa fa-step-forward"> </i> </button></a>
...
<div style="width: 82%; margin-left: 0px; padding: 15px;" class="desc">
        ...
        <p id="dpa2" style="color: white;">'. $desc_1 . ' <a style="display:inline-block;" onclick="des2(1)" id="daa2">Read More...</a></p>
        <p id="dpb2" style="color: white; display: none;"> '. $desc_2 . ' </p>
    </div></center>
