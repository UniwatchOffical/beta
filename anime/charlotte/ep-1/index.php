...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.8.1/font/bootstrap-icons.css">
    ...
    <title>Ep-1, Charlotte | Uniwatch</title>
</head>
...
function ads(value) {
    ...
    if (value == 0) {
        ...
        url = "../videos/video.mp4";
        document.getElementById('vid').src = "https://drive.google.com/file/d/1-AWkscAAXKIlgvT97bAsHkaj0rXlUmqX/preview";
        document.getElementById('skip').style.display = "none";
...
<a href="../ep-2"><button style=" width: 200px; height: 50px; border-radius: 10px;" id="nxt" class="skp pc">Next Episode <i class="fa fa-step-forward"> </i> </button></a>
</div>
...
<!----------------------- details ------------------------------------------------------------->
   ...
   <div style="margin-top: 140px;" id="detail" class="detail">
        <h1 style="color: white; display: inline-block;" id="dha">Charlotte</h1> <br>
...
function des2(value) {
    ...
    <div class="desc">
        ...
        <p id="dpa" style="color: white;">Charlotte is a 2015 Japanese anime television series produced by P.A.Works and Aniplex and directed by Yoshiyuki Asai. The anime aired 13 episodes in Japan between July 5 and September 27, 2015. <a style="display:inline-block;" onclick="des(1)" id="daa">Read More...</a></p>
        <p id="dpb" style="color: white; display: none;">Charlotte takes place in an alternate reality where a short-period comet called Charlotte passes near Earth once every 75 years. As this happens, it spreads dust onto the Earth, which causes a small percentage of preadolescent children who inhale the dust to manifest superhuman abilities upon reaching puberty.</p>
    </div>
...
<h1 class="title"><b>Charlotte</b> <br> <i style="color: rgba(255,255,255,0.6); font-style:none; font-size: 18px; margin-top: 8px;">S-1 . Ep-1</i> <br>
...
<center>
<a href="../ep-2"><button class="btn black">Next <i class="fa fa-step-forward"> </i> </button></a>
...
<div style="width: 82%; margin-left: 0px; padding: 15px;" class="desc">
        ...
        <p id="dpa2" style="color: white;">Charlotte is a 2015 Japanese anime television series produced by P.A.Works and Aniplex and directed by Yoshiyuki Asai. The anime aired 13 episodes in Japan between July 5 and September 27, 2015. <a style="display:inline-block;" onclick="des2(1)" id="daa2">Read More...</a></p>
        <p id="dpb2" style="color: white; display: none;">Charlotte takes place in an alternate reality where a short-period comet called Charlotte passes near Earth once every 75 years. As this happens, it spreads dust onto the Earth, which causes a small percentage of preadolescent children who inhale the dust to manifest superhuman abilities upon reaching puberty.</p>
    </div></center>
