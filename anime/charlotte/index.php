...
$cover = "charlotte2.jpeg";
$ep_img = "charlotteep.jpg";
$anime_name = "Charlotte"
...
nav{
      ...
      .ep{
          ...
          margin: 25px;
          background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(../../images/<?php echo "{$ep_img}";?>);
          display: inline-block;
      }
      .ep:hover{
          ...
          margin: 21px;
          background: linear-gradient(rgba(0,0,0,0.8), rgba(0,0,0,0.8)), url(../../images/<?php echo "{$ep_img}";?>);
      }
      .ep h2{
          color: gold;
          margin-top: 100px;
...
<div class="main-btn">
    <a href="ep-1"><button class="btn btn1 gold"><i class="fa fa-play"> </i> Watch Now</button></a> <br>
    <a target="blank" href="https://www.facebook.com/sharer/sharer.php?u=uniwatch.ml/anime/charlotte"><button class="btn gold"><i class="fa fa-share-alt"> </i> Share</button></a> <br>
    <a href="#episod"><button onclick="hid(1)" class="btn gold"><i class="fa fa-th-large"> </i> All Episods</button></a> <br>
