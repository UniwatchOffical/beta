...
<nav style="background:;width: 100%;" class="pc">
    ...
    <li class="li-menu"><a href="../">Home</a></li>
        ...
        <li class="li-menu"><a style="color: white;" href="#">Animes</a></li>
...
<script>
    ...
    <div class="movie-list">
        <a class="mlaa" href="../">Home</a> <i id="mlab" style="color: white;" class="fa fa-angle-right"></i> <a class="mlac" href="#">Animes</a> <br>

    <h1 style="color: white;" id="mh">Latest Animes</h1>

   <center>
        <a href="yourname"><div style="" class="movie m2 m1">
            <img src="../images/yourname.jpg" alt=""> <br>
            <h2 style="color: white;" id="mha">Your Name</h2>
        </div></a>


        <a href="charlotte"><div class="movie">
            <img src="../images/charlotte2.jpeg" alt=""> <br>
            <h2 style="color: white;" id="mhb">Charlotte</h2>
        </div></a>


        <a href="naruto"><div class="movie m2">
            <img src="../images/naruto.jpg" alt=""> <br>
            <h2 style="color: white;" id="mhc">Naruto</h2>
        </div></a>

        <a href="weathringwithyou"><div class="movie">
            <img src="../images/weathring.jpg" alt=""> <br>
            <h2 style="color: white;" id="mhd">Weathering With..</h2>
        </div></a>

        <a href="erased"><div class="movie m2">
            <img src="../images/erased.jpg" alt=""> <br>
            <h2 style="color: white;" id="mhe">Erased</h2>
        </div></a>


        <a href="f9"><div class="movie">
            <img src="../images/joseetigerandfish.jpg" alt=""> <br>
            <h2 style="color: white;" id="mhf">Josee,Tiger..</h2>
        </div></a>
    </div>
    </center>

    
<center><div class="soon">
        <h1 id="soon" style="color: white;">More Anime are Coming Soon...</h1>
    </div></center>
...
<li style="list-style: none;  width: 85%; border-bottom: 1px solid white; height: 70px; margin-left: 0px;"><a style="margin-left: 0px;color: white; text-decoration: none; margin-top: 20px; display: inline-block; font-size: 25px;" href="#">Japanese</a></li>
</center>
</div>
