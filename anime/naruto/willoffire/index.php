...
$anime_name = "Naruto: Will of Fire";
$next = "../losttower";
$next_img="losttower.jpg";
$next2 = "../thelast";
$next2_img="last.jpg";
$cat = "Anime";
$share = "https://www.facebook.com/sharer/sharer.php?u=uniwatch.ml/anime/naruto/willoffire";
$desc_1 = "Naruto Shippuden the Movie: The Will of Fire (Japanese: 劇場版 NARUTOナルト 疾風伝 火の意志を継ぐ者, Hepburn: Gekijōban Naruto Shippūden Hi no Ishi wo Tsugumono, lit. Inheritance of the Will of Fire), the sixth Naruto film overall and the third Naruto:Shippuden film, takes as its basis the popular anime and manga series. Released on August 1, 2009 in theaters in Japan (Maramusa Notari planned to release a DVD on April 21, 2010)";
$desc_2 = "In the potential outbreak of a 4th Great Ninja World War, a few ninjas with Kekkei Genkai (血継限界, lit. bloodline trait) abilities had disappeared from the land of Lightning, Earth, Water & Wind. The Land of Fire remains the only village not affected by these events, so people start to suspect its role in these incidents, & rumors of a possible rebellion begin to circulate. With the other nations amassing troops on the borders of the Land of Fire & threatening invasion, the Feudal Lord of the Land of Fire orders Tsunade to capture the real culprit & prove Konoha's innocence, in the event of failure, the Land of Fire will destroy the village to preserve world";
$video_url = "https://drive.google.com/file/d/12qj98OCBgl10GspyT9xxFej8BLZBawL1/preview";
...
<!----------------------- details ------------------------------------------------------------->
   ...
   <div style="margin-top: 140px;" id="detail" class="detail">
        ...
        <a style="color: lightgreen;" href="../"><p><i class="fa fa-paw"> </i> <span> </span><?php echo "{$cat}"; ?></p></a>
...
<a style="color: lightgreen;" href="../../"><p style="display: inline-block;"><i style="" class="fa fa-paw"> </i> <span> </span><?php echo "{$cat}"; ?></p></a>
