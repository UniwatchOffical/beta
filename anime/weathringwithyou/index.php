...
<a href=" <?php echo "{$next}"; ?> "><button style=" width: 200px; height: 50px; border-radius: 10px;" id="nxt" class="skp pc">Next Anime <i class="fa fa-step-forward"> </i> </button></a>
</div>
