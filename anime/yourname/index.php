...
$next2 = "../weathringwithyou";
$next2_img="weathring.jpg";
$cat = "Anime";
$share = "https://www.facebook.com/sharer/sharer.php?u=uniwatch.ml/anime/weatheringwithyou";
$desc_1 = "Your Name (Japanese: 君の名は。, Hepburn: Kimi no Na wa.) is a 2016 Japanese animated romantic fantasy film produced by CoMix Wave Films and released by Toho. It depicts a high school boy in Tokyo and a high school girl in the Japanese countryside who suddenly and inexplicably begin to swap bodies.";
$desc_2 = "n 2013, Mitsuha Miyamizu is a high school girl living in the rural town of Itomori, Japan. Bored of the town, she wishes to be a Tokyo boy in her next life. One day, she inexplicably begins to switch bodies intermittently with Taki Tachibana, a high school boy in Tokyo: thus when they wake up as each other on some mornings, they must live through the other's respective activities and social interactions for the day. They learn they can communicate with each other by leaving messages on paper, phones, and sometimes on each other's skin. Mitsuha (in Taki's body) sets Taki up on a date with coworker Miki Okudera, while Taki (in Mitsuha's body) causes Mitsuha to become popular at school. ";
$video_url = "https://drive.google.com/file/d/1bfr3wIohwM3g0Y34hiLdPFqWWiK9Hplx/previewhttps://drive.google.com/file/d/148-6RLo7AWp3XlS-85uFvMQTnOnTCuPS/preview";
