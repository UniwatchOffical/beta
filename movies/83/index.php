...
$cat = "Movie";
$share = "https://www.facebook.com/sharer/sharer.php?u=uniwatch.ml/movies/83";
$desc_1 = "83 is a 2021 Indian Hindi-language sports drama film written and directed by Kabir Khan and produced by Deepika Padukone, Kabir Khan, Vishnu Vardhan Induri, Sajid Nadiadwala, Reliance Entertainment.[6][7] Based on the India national cricket team led by Kapil Dev, which won the 1983 Cricket World Cup, the film's story and dialogues were co-written by Khan, along with Sanjay Puran Singh Chauhan, Vasan Bala and Sumit Arora.";
$desc_2 = "The film's sports action was directed by Rob Miller and the ReelSports team. It stars Ranveer Singh as Kapil Dev and Padukone as Romi Dev, Dev's wife, featuring an ensemble cast of Pankaj Tripathi, Tahir Raj Bhasin, Jiiva, Saqib Saleem, Jatin Sarna, Chirag Patil, Dinker Sharma, Nishant Dahiya, Harrdy Sandhu, Sahil Khattar, Ammy Virk, Adinath Kothare, Dhairya Karwa and R. Badree. Phantom Films which owned the rights for the film, with its co-producers Madhu Mantena and Vishnu Vardhan Induri formally met the Indian squad of 1983 during mid-July 2016, and its frontman Kapil Dev, where they signed a Memorandum of understanding (MoU) to make the official biopic";
