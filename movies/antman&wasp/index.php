...
$anime_name = "Antman & Wasp";
$next = "../nowayhome";
$next_img="nowayhome.jfif";
$next2 = "../captainmarvel";
$next2_img="captainmarvel.jpg";
$cat = "Movie";
$share = "https://www.facebook.com/sharer/sharer.php?u=uniwatch.ml/movies/antman&wasp";
$desc_1 = "Ant-Man and the Wasp is a 2018 American superhero film based on Marvel Comics featuring the characters Scott Lang / Ant-Man and Hope Pym / Wasp. Produced by Marvel Studios and distributed by Walt Disney Studios Motion Pictures, it is the sequel to Ant-Man (2015) and the 20th film in the Marvel Cinematic Universe (MCU). ";
$desc_2 = "Two years after Scott Lang was placed under house arrest due to his involvement with the Avengers, in violation of the Sokovia Accords,[N 1] Hank Pym and his daughter Hope van Dyne briefly manage to open a tunnel to the Quantum Realm. They believe Pym's wife Janet van Dyne might be trapped there after shrinking to sub-atomic levels in 1987. When he had previously visited the quantum realm, Lang had unknowingly become quantumly entangled with Janet, and now he receives an apparent message from her.";
$video_url = "https://drive.google.com/file/d/1FsQJ2QLO1tfa_Tz17yPQ3CeeE43qmtX1/preview";
