...
$anime_name = "Bachchhan Paandey";
$next = "../kashmirfiles";
$next_img="kashmirfiles.jpg";
$next2 = "../pushpa";
$next2_img="pushpa.jpg";
$cat = "Movie";
$share = "https://www.facebook.com/sharer/sharer.php?u=uniwatch.ml/movies/bachanpandey";
$desc_1 = "Bachchhan Paandey is a 2022 Indian Hindi-language action comedy film directed by Farhad Samji and produced by Sajid Nadiadwala. It stars Akshay Kumar, Kriti Sanon, Jacqueline Fernandez and Arshad Warsi. It is a remake of the 2014 Tamil film Jigarthanda [7][8] which itself was inspired by the 2006 South Korean movie A Dirty Carnival.";
$desc_2 = "Myra Devekar (Kriti Sanon), a budding director is given a task by a producer to come up with a gripping and violent gangster story to produce a film. To satisfy the producer's commercial outlook and her hunger for making a realistic flick, she decides to study the life of a real-life gangster for the script. Her extensive research leads to menacing one-eyed Bachchhan Paandey (Akshay Kumar) of Baagwa, a ruthless gangster surrounded by quirky yet scary henchmen.";
