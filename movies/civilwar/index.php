...
$anime_name = "Civil War";
$next = "../wintersoldier";
$next_img="wintersoldier.jpg";
$next2 = "../doctorstrange";
$next2_img="drstrange.jpg";
$cat = "Movie";
$share = "https://www.facebook.com/sharer/sharer.php?u=uniwatch.ml/movies/civilwar";
$desc_1 = "Captain America: Civil War is a 2016 American superhero film based on the Marvel Comics character Captain America, produced by Marvel Studios and distributed by Walt Disney Studios Motion Pictures. It is the sequel to Captain America: The First Avenger (2011) and Captain America: The Winter Soldier (2014),";
$desc_2 = "In 1991, the brainwashed super-soldier James Bucky Barnes is dispatched from a Hydra base in Siberia to intercept an automobile carrying a case of super-soldier serum. In the present day, approximately one year after Ultron is defeated by the Avengers in the nation of Sokovia,[N 1] Steve Rogers, Natasha Romanoff, Sam Wilson, and Wanda Maximoff stop Brock Rumlow from stealing a biological weapon from a lab in Lagos. Rumlow blows himself up, attempting to kill Rogers.";
$video_url = "https://drive.google.com/file/d/1zoT5iax5npU2epURndrAmrlcwRTW68gu/preview";
