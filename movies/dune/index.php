...
$anime_name = "Dune 2021";
$next = "../f9";
$cat = "Movie";
$desc_1 = "Dune (titled onscreen as Dune: Part One) is a 2021 American epic science fiction film directed by Denis Villeneuve from a screenplay by Villeneuve, Jon Spaihts, and Eric Roth.";
$desc_2 = "In the far future, Duke Leto of House Atreides, ruler of the ocean planet Caladan, is assigned by the Padishah Emperor Shaddam Corrino IV to replace House Harkonnen as fief rulers of Arrakis, a harsh desert planet and the only source of spice, a valuable substance that grants its users heightened vitality and consciousness.";
$video_url = "https://drive.google.com/file/d/1MrVMWqpGmVSxkd29fKb05sbnWQRohb5z/preview";
