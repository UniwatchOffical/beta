...
$anime_name = "Avengers: Endgame";
$next = "../infinitywar";
$cat = "Movie";
$desc_1 = "Avengers: Endgame is a 2019 American superhero film based on the Marvel Comics superhero team the Avengers. Produced by Marvel Studios and distributed by Walt Disney Studios Motion Pictures.";
$desc_2 = "In 2018, twenty-three days after Thanos killed half of all life in the universe,[N 1] Carol Danvers rescues Tony Stark and Nebula from deep space and they reunite with the remaining Avengers—Bruce Banner, Steve Rogers, Thor, Natasha Romanoff, and James Rhodes—and Rocket on Earth. Locating Thanos on an uninhabited planet.";
$video_url = "https://drive.google.com/file/d/1Qwo-aZ1Bf8dEnRKzjxPatZBZrz1YsCfQ/preview";
?>
...
<div style="margin-bottom: 40px;" id="episod" class="movie-list">
   ...
   <a href="../infinitywar">
      ...
      <div class="ep">
           <img src="../../images/infinitywar.webp" alt="">
       </div>

   </a>

   <a href="../captainmarvel">

   <div class="ep">
           <img src="../../images/captainmarvel.jpg" alt="">
       </div>
