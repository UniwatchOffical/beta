...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.8.1/font/bootstrap-icons.css">
    ...
    <title>Flying Fyn| Uniwatch</title>
</head>
...
function ads(value) {
    ...
    if (value == 0) {
        ...
        url = "../videos/video.mp4";
        document.getElementById("vid").src = " https://drive.google.com/file/d/1dKdajhzXn7TKI13JbC4PeA2NAwB-UDU3/preview ";
        document.getElementById("skip").style.display = "none";
...
<a href=" ../endgame "><button style=" width: 200px; height: 50px; border-radius: 10px;" id="nxt" class="skp pc">Next movie <i class="fa fa-step-forward"> </i> </button></a>
</div>
...
<!----------------------- details ------------------------------------------------------------->
   ...
   <div style="margin-top: 140px;" id="detail" class="detail">
        <h1 style="color: white; display: inline-block;" id="dha">Flying Fyn</h1> <br>
        <a style="color: lightgreen;" href="../"><p><i class="fa fa-film"> </i> <span> </span>movies</p></a>
...
function des2(value) {
    ...
    <div class="desc">
        ...
        <p id="dpa" style="color: white;">Bachchhan Paandey is a 2022 Indian Hindi-language action comedy film directed by Farhad Samji and produced by Sajid Nadiadwala. It stars Akshay Kumar, Kriti Sanon, Jacqueline Fernandez and Arshad Warsi. It is a remake of the 2014 Tamil film Jigarthanda [7][8] which itself was inspired by the 2006 South Korean movie A Dirty Carnival.<a style="display:inline-block;" onclick="des(1)" id="daa">Read More...</a></p>
        <p id="dpb" style="color: white; display: none;">Myra Devekar (Kriti Sanon), a budding director is given a task by a producer to come up with a gripping and violent gangster story to produce a film. To satisfy the producer's commercial outlook and her hunger for making a realistic flick, she decides to study the life of a real-life gangster for the script. Her extensive research leads to menacing one-eyed Bachchhan Paandey (Akshay Kumar) of Baagwa, a ruthless gangster surrounded by quirky yet scary henchmen.</p>
    </div>
...
<h1 class="title"><b>Flying Fyn</b>  <br>
...
<center>
<a href=" ../endgame "><button class="btn black">Next <i class="fa fa-step-forward"> </i> </button></a>
...
<div style="width: 82%; margin-left: 0px; padding: 15px;" class="desc">
        ...
        <p id="dpa2" style="color: white;">Bachchhan Paandey is a 2022 Indian Hindi-language action comedy film directed by Farhad Samji and produced by Sajid Nadiadwala. It stars Akshay Kumar, Kriti Sanon, Jacqueline Fernandez and Arshad Warsi. It is a remake of the 2014 Tamil film Jigarthanda [7][8] which itself was inspired by the 2006 South Korean movie A Dirty Carnival. <a style="display:inline-block;" onclick="des2(1)" id="daa2">Read More...</a></p>
        <p id="dpb2" style="color: white; display: none;"> Myra Devekar (Kriti Sanon), a budding director is given a task by a producer to come up with a gripping and violent gangster story to produce a film. To satisfy the producer's commercial outlook and her hunger for making a realistic flick, she decides to study the life of a real-life gangster for the script. Her extensive research leads to menacing one-eyed Bachchhan Paandey (Akshay Kumar) of Baagwa, a ruthless gangster surrounded by quirky yet scary henchmen. </p>
    </div></center>
