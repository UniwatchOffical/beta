...
$next = "../blackwidow";
$cat = "Movie";
$desc_1 = "Free Guy is a 2021 action comedy film directed and produced by Shawn Levy from a screenplay by Matt Lieberman and Zak Penn, and a story by Lieberman. It stars Ryan Reynolds as Guy, a bank teller who discovers he is actually a non-player character in a massively multiplayer online video game.";
$desc_2 = "TWhen a bank teller discovers he's actually a background player in an open-world video game, he decides to become the hero of his own story -- one that he can rewrite himself. In a world where there's no limits, he's determined to save the day his way before it's too late, and maybe find a little romance with the coder who conceived him.";
$video_url = "https://drive.google.com/file/d/11MZ2ayQWtrFAWuForv4RXRlJ7QjucDZ_/preview";
...
/*------------ Video Player ------------*/
      ...
      .ep1{
        background: url(../../images/blackwidow.jfif);
      }

      .ep2{
        background: url(../../images/apex.jfif);
      }
