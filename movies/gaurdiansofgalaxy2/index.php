...
$anime_name = "Gaurdians of Glaxy Vol2";
$next = "../ironman3";
$next_img="ironman3.jpg";
$next2 = "../doctorstrange";
$next2_img="drstrange.jpg";
$cat = "Movie";
$share = "https://www.facebook.com/sharer/sharer.php?u=uniwatch.ml/movies/gaurdiansofgalaxy2";
$desc_1 = "Guardians of the Galaxy Vol. 2 is a 2017 American superhero film based on the Marvel Comics superhero team Guardians of the Galaxy, produced by Marvel Studios and distributed by Walt Disney Studios Motion Pictures. It is the sequel to Guardians of the Galaxy (2014) and the 15th film in the Marvel Cinematic Universe (MCU).";
$desc_2 = "In 2014, Peter Quill, Gamora, Drax, Rocket, and Baby Groot are renowned as the Guardians of the Galaxy. Ayesha, leader of the Sovereign race, has the Guardians protect valuable batteries from Abilisk, an inter-dimensional monster, in exchange for Gamora's estranged sister Nebula, who was caught attempting to steal the batteries. After Rocket steals the batteries for himself, the Sovereign attacks the Guardians' ship with a fleet of drones. ";
$video_url = "https://drive.google.com/file/d/1o5LJRJ9fHaTiuolbZ2PMcy7tHOF3nEME/preview";
