...
<a href="  "><button style=" width: 200px; height: 50px; border-radius: 10px;" id="nxt" class="skp pc">Next movie <i class="fa fa-step-forward"> </i> </button></a>
</div>
...
<!----------------------- details ------------------------------------------------------------->
   ...
   <div style="margin-top: 140px;" id="detail" class="detail">
        <h1 style="color: white; display: inline-block;" id="dha"></h1> <br>
        <a style="color: lightgreen;" href="../"><p><i class="fa fa-film"> </i> <span> </span>movie</p></a>
...
function des2(value) {
    ...
    <div class="desc">
        ...
        <p id="dpa" style="color: white;"><a style="display:inline-block;" onclick="des(1)" id="daa">Read More...</a></p>
        <p id="dpb" style="color: white; display: none;"></p>
    </div>
...
<center>
<a href="  "><button class="btn black">Next <i class="fa fa-step-forward"> </i> </button></a>
...
<div style="width: 82%; margin-left: 0px; padding: 15px;" class="desc">
        ...
        <p id="dpa2" style="color: white;"> <a style="display:inline-block;" onclick="des2(1)" id="daa2">Read More...</a></p>
        <p id="dpb2" style="color: white; display: none;">  </p>
    </div></center>
