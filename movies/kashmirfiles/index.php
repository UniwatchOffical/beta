...
$anime_name = "Kashmir Files";
$next = "../nowayhome";
$cat = "Movie";
$desc_1 = "The Kashmir Files is a 2022 Indian Hindi-language drama film,[2] produced by Zee Studios. Written and directed by Vivek Agnihotri,[5] the film presents a fictional storyline.";
$desc_2 = "In 1989-90 Kashmir, Islamic militants storm and banish Kashmiri Hindu Pandits from the Kashmir valley using the slogans Raliv Galiv ya Chaliv ('convert (to Islam), leave or die) and Mustafa Batte Safa ('with god's grace whole Kashmiri Pandit community will leave valley'). Pushkar Nath Pandit, a teacher, fears for the safety of his son Karan, who has been accused by the militants of being an Indian spy.";
$video_url = "https://drive.google.com/file/d/10guGBlPnvhrlLiFk2xx9EQAH7Srd57Zn/preview";
?>
...
/*------------ Video Player ------------*/
      ...
      .ep1{
        background: url(../../images/nowayhome.jfif);
      }
