...
$anime_name = "No Time To Die";
$next = "../nowayhome";
$cat = "Movie";
$desc_1 = "No Time to Die is a 2021 spy film and the twenty-fifth in the James Bond series produced by Eon Productions. It stars Daniel Craig in his fifth and final outing as the fictional British MI6 agent James Bond.";
$desc_2 = "James Bond is enjoying a tranquil life in Jamaica after leaving active service. However, his peace is short-lived as his old CIA friend, Felix Leiter, shows up and asks for help. The mission to rescue a kidnapped scientist turns out to be far more treacherous than expected, leading Bond on the trail of a mysterious villain who's armed with a dangerous new technology. In the past, a young Madeleine Swann witnesses the murder of her mother by Lyutsifer Safin in a failed attempt to murder her father Mr. White. Madeleine shoots Safin, but he survives. She flees onto a nearby frozen lake and falls through the ice, but he rescues her";
$video_url = "https://drive.google.com/file/d/1kBpZaPswAzh-XSS5wYKcEU7wXsIi0LoK/preview";
?>
