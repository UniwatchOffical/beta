...
$anime_name = "Pushpa: The Rise";
$next = "../rrr";
$next_img="rrr.jpg";
$next2 = "../pattack";
$next2_img="attack.jpg";
$cat = "Movie";
$share = "https://www.facebook.com/sharer/sharer.php?u=uniwatch.ml/movies/pushpa";
$desc_1 = "Pushpa: The Rise Part 01 is a 2021 Indian Telugu-language action drama film[5] written and directed by Sukumar. Produced by Mythri Movie Makers in association with Muttamsetty Media, it stars Allu Arjun as the titular character alongside Fahadh Faasil, in his Telugu debut, and Rashmika Mandanna while Jagadeesh Prathap Bandari, Sunil, Rao Ramesh, Dhananjaya, Anasuya Bharadwaj, Ajay and Ajay Ghosh play supporting roles.";
$desc_2 = "In the 1990s,[13] Pushpa Raj is a coolie who works to smuggle red sandalwood, a rare wood that only grows in the Seshachalam Hills of the Chittoor district in Andhra Pradesh. When DSP Govindappa raids them in the forest, Pushpa hides and recovers the stock, thereby gaining the trust of his employer Konda Reddy. With the help of novel ideas to smuggle the red sandalwood, he quickly rises through the ranks and becomes Konda Reddy's partner. Mangalam Srinu, a merciless dealer who manages the red sandalwood syndicate entrusts Konda Reddy to keep 200 tons of his stock safe. As Konda's younger brother, Jolly Reddy is deemed incompetent, Pushpa is given the job. Govindappa attempts to raid them but Pushpa throws all the logs into the river, saving it from being seized. ";
$video_url = "https://drive.google.com/file/d/1dKdajhzXn7TKI13JbC4PeA2NAwB-UDU3/preview";
