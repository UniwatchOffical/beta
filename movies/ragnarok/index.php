...
$anime_name = "Thor: Ragnarok";
$next = "../infinitywar";
$next_img="infinitywar.webp";
$next2 = "../darkworld";
$next2_img="darkworld.jpg";
$cat = "Movie";
$desc_1 = "Thor: Ragnarok is a 2017 American superhero film based on the Marvel Comics character Thor, produced by Marvel Studios and distributed by Walt Disney Studios Motion Pictures.";
$desc_2 = "Two years after the battle of Sokovia,[N 1] Thor is imprisoned by the fire demon Surtur, who reveals that Thor's father Odin is no longer on Asgard. He explains that the realm will soon be destroyed during the prophesied Ragnarök, once Surtur unites his crown with the Eternal Flame that burns in Odin's vault.";
$video_url = "https://drive.google.com/file/d/1a34THJZHHt2JCsNRDobizjL8jIn-q63X/preview";
