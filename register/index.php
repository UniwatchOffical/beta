...
<center><div class="main">
  <img src="../images/acrobet.jpg" alt="Acrobet"> <br>
...
<form style="margin-left: 0px;" action="" method="post">
  <div class="form-row">
    <div class="form-group col-md-12">
      ...
      <input type="text" class="form-control" name="username" id="inputEmail4" placeholder="Email"> <br>
    </div> <br>
  ...
  <button style=" " type="submit" class="btn blue">Sign in</button>
</form>
</div></center>
