...
<div class="search">
       <center><div class="search-box">
            ...
            <a href="../"><i style="margin-left: 20px;" class="fa fa-times"></i></a>
...
<div class="item">
    <a href="../movies/nowayhome"><div class="item-1 s1">
    ...
    <a href="../movies/notimetodie"><div class="item-1 s2">
    ...
    <a href="../movies/venom2"><div class="item-1 s3">
    ...
    <a href="../movies/eternals"><div class="item-1 s4">
    ...
    <a href="../movies/shangchi"><div class="item-1 s5">
    ...
    <a href="../movies/f9"><div class="item-1 s6">
    ...
    <a href="../live_news/aajtak"><div class="item-1 s7">
