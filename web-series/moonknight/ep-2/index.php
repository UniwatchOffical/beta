...
$anime_name = "Moon Knight";
$ep = "EP-2";
$ep_img ="moonknight.jpg";
$next = "../ep-3";
$cat = "Web Series";
$desc_1 = "Moon Knight is an American television miniseries created by Jeremy Slater for the streaming service Disney+, based on the Marvel Comics featuring the character of the same name.";
$desc_2 = "Steven Grant and mercenary Marc Spector investigate the mysteries of the Egyptian gods from inside the same body.";
$video_url = "https://drive.google.com/file/d/1-jsx94hn2pYyWURTgu_OeVjw_b1kOtZ_/preview";
?>
...
<div id="episod" class="movie-list">
   ...
   <div class="ep">
           <img src="../../../images/<?php echo "{$ep_img}";?>" alt=""> <br>
           <h2>Episode: 1</h2>
       </div>
...
<div id="episod" style="margin-bottom:90px;" class="movie-list">
